	...
	<article class="module width_3_quarter">
		...
		switch ($_action) {
			...
			<fieldset class="hr">
				...
				echo $Helper->buildCombo_risk ( "satker", $arr_auditee, 0, 2, $base_on_id_eks, "", false, true, false,  "span7" );
		...
		<?
			...
			<fieldset class="hr">
				...
				$arr_auditee = $rs_auditee->GetArray ();
				echo $Helper->buildCombo_risk ( "satker", $arr_auditee, 0, 2, $arr ['penetapan_auditee_id'], "", false, true, false,  "span7" );
				?><span class="mandatory">*</span>
			</fieldset>
			<fieldset class="hr">
				<label class="span2">Tahun</label> <select class="span1"
