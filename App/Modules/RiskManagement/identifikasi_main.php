...
$gridHeader = array ("Nomor Risiko", "Nama Risiko", "Kategori Risiko", "Faktor Penyebab Risiko", "Selera Risiko");
...
$key_by = array ("Nomor Risiko", "Nama Risiko", "Kategori Risiko", "Faktor Penyebab Risiko", "Selera Risiko");
...
switch ($_action) {
	...
	case "postadd" :
		...
		$fselera = $Helper->replacetext ( $_POST ["selera"] );
		...
		if ($fnama != "" && $fkategori != "" && $fpenyebab != "" && $fselera != "") {
			$risks->identifikasi_add ( $ses_penetapan_id, $nomor_risiko, $fnama, $fkategori, $fpenyebab, $fselera );
...
<?
	...
	case "postedit" :
		...
		$fselera = $Helper->replacetext ( $_POST ["selera"] );
		if ($fnama != "" && $fkategori != "" && $fpenyebab != "" && $fselera != "") {
			$risks->identifikasi_edit ( $fdata_id, $fnama, $fkategori, $fpenyebab, $fselera );
			$risks->reset_data_risk ( $ses_penetapan_id );
