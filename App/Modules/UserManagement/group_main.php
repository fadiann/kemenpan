...
$paging_request = "main.php?method=par_group";
			...
			if ($fgroup_id == "") {
				...
				**/
				for($data_parrent=1;$data_parrent<=4;$data_parrent++){
					$data_method = "";
					$data_parrent_id = $Helper->replacetext ( $_POST ["parrent_" . $data_parrent] );
				...
				$rs_menu = $Helper->menu_list_view ();
				while ( $arr_menu = $rs_menu->FetchRow () ) {
					$menu_id = $Helper->replacetext ( $_POST ["menu_" . $arr_menu ['menu_id']] );
