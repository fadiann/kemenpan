<form method="post" name="f" action="#">
	<section id="main" class="column">
		<article class="module width_3_quarter">
			...
			<?php if($iconAdd){?>
				<ul class="tabs">
						<li><a href="#" OnClick="return set_action('getadd');">Tambah</a>
						</li>
					</ul>
			<?php }?>
				<input type="hidden" value="" name="data_action" id="data_action"> <input
						type="hidden" value="" name="data_id" id="data_id">
				</form>
			</header>
			<header>
				<ul class="tabs">
