...
$paging_request = "main.php?method=par_menu&parrent=" . $parrent;
...
$grid = "App/Templates/Grids/grid_menu.php";
...
switch ($_action) {
	...
	case "postadd" :
		...
		$flink = $Helper->replacetext ( $_POST ["link"] );
		$fmethod = $Helper->replacetext ( $_POST ["method"] );
		$ffile = $Helper->replacetext ( $_POST ["file"] );
