		...
		<section class="panel">
			...
			<center>
				<div class="form-group mt-md">
					<a class="btn btn-info" href="Api/rekap_perencanaan_print.php?fil_tahun_id=<?=$fil_tahun_id?>&fil_tipe_id=<?=$fil_tipe_id?>" target="_blank"><i class="fa fa-download"> </i> Download</a>
				</div>
			</center>
