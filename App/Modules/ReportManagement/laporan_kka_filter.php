...
<section id="main" class="column">
	<article class="module width_3_quarter">
		<header>
			<h3 class="tabs_involved">Filter Pelaporan Kertas Kerja Audit</h3>
		</header>
		<form method="post" name="f" action="main.php?method=laporan_kka" class="form-horizontal" id="validation-form">
			...
			<fieldset class="form-group">
				...
				echo $Helper->buildCombo ( "fil_auditee_id", $arr_auditee, 0, 1, "", "", "", false, false, true );
				?>
