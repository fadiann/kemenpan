	...
	<table align="center" width="100%">
		...
		<tr>
			<td align="center" colspan="3">
				<input type="button" class="blue_btn" value="ms-word" onClick="window.open('ReportManagement/laporan_lha_print.php?fil_tahun_id=<?=$fil_tahun_id?>&fil_auditee_id=<?=$fil_auditee_id?>', '_blank','toolbar=no,location=no,status=no,menubar=yes,scrollbars=yes,resizable=yes');"></td>
		</tr>
	</table>
</section>
<?
...
?>
	<script>window.open('main.php?method=laporan_lha_filter', '_self');</script>
<?
}
?>