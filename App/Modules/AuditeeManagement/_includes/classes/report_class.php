...
class report {
	...
	function assign_list($assign_id) {
		$sql = "select assign_id, assign_surat_no, assign_no_lha, assign_date_lha, assign_periode, lha_ringkasan, assign_dasar, lha_metodologi, assign_kegiatan, lha_tujuan_audit, lha_ruanglingkup, lha_batasan, lha_kegiatan, assign_start_date, assign_end_date, lha_strategi_laporan, lha_hasil, lha_status
				FROM assignment
