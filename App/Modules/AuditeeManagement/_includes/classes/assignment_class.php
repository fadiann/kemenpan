...
class assign {
	...
	function view_auditor_assign($assign_id) {
		$sql = "select auditor_id, auditor_name, auditor_nip, posisi_name, MIN(assign_auditor_start_date) as start_date, MAX(assign_auditor_end_date) as end_date, pangkat_name,  jenis_jabatan
	...
	function assign_auditor_add($id, $auditee_id, $anggota_id, $posisi_id, $tanggal_awal, $tanggal_akhir, $jml_hari, $assign_id, $hari_kerja) {
		$sql = "insert into assignment_auditor 
				(assign_auditor_id, assign_auditor_id_auditee, assign_auditor_id_auditor, assign_auditor_id_posisi, assign_auditor_start_date, assign_auditor_end_date, assign_auditor_day, assign_auditor_id_assign, assign_auditor_workday) 
				values
				('".$id."','".$auditee_id."','".$anggota_id."','".$posisi_id."','".$tanggal_awal."','".$tanggal_akhir."','".$jml_hari."','".$assign_id."','".$hari_kerja."')";
	...
	function assign_auditor_edit($id, $auditee_id, $anggota_id, $posisi_id, $tanggal_awal, $tanggal_akhir, $jml_hari, $hari_kerja) {
		$sql = "update assignment_auditor set assign_auditor_id_auditee = '".$auditee_id."', assign_auditor_id_auditor = '".$anggota_id."', assign_auditor_id_posisi = '".$posisi_id."', assign_auditor_start_date = '".$tanggal_awal."', assign_auditor_end_date = '".$tanggal_akhir."', assign_auditor_day = '".$jml_hari."', assign_auditor_workday = '".$hari_kerja."'
				where assign_auditor_id = '".$id."' ";
	...
	function lha_update ( $id, $no_lha, $tanggal_lha, $ringkasan, $dasar_audit, $tujuan_audit, $ruang_lingkup, $batasan_tanggung_jawab, $metodologi_audit, $strategi_laporan, $data_umum_auditan, $hasil_yang_dicapai, $status_lha) {
		$sql = "update assignment_lha set lha_no = '".$no_lha."', lha_date = '".$tanggal_lha."', lha_ringkasan = '".$ringkasan."', lha_dasar_audit = '".$dasar_audit."', lha_tujuan_audit = '".$tujuan_audit."', lha_ruanglingkup = '".$ruang_lingkup."', lha_batasan = '".$batasan_tanggung_jawab."', lha_metodologi = '".$metodologi_audit."', lha_strategi_laporan = '".$strategi_laporan."', lha_data_auditan = '".$data_umum_auditan."', lha_hasil = '".$hasil_yang_dicapai."', lha_status = '".$status_lha."' where lha_id_assign = '".$id."'";
		$data = $this->_db->_dbquery ( $sql );
	}
