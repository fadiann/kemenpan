...
$key_by = array ("Kode Auditee", "Nama Auditee", "Unit Penanggung Jawab", "email");
$key_field = array ("auditee.auditee_kode", "auditee.auditee_name", "parrent.auditee_name", "auditee.auditee_email");
$widthAksi = "15";
$iconDetail = "1";
// === end grid ===//
switch ($_action) {
