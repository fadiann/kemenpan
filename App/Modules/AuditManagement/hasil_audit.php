	...
	<form method="post" name="f" action="#" class="form-horizontal" id="validation-form" enctype="multipart/form-data"  onsubmit="return cek_data()">
			<fieldset>
				...
				<div id="view1">
					...
					<fieldset class="hr">
						<label class="span2">Tanggal LHA</label> 
						<input type="text" class="span1" name="tanggal_lha" id="tanggal_lha" value="<?=$Helper->dateIndo($arr_lha['lha_date'])?>"> 
					</fieldset>
				</div>
				<div id="view2">
					<fieldset>
						<label class="span5">Simpulan Hasil Audit dan Rekomendasi</label>
					</fieldset>
					<fieldset>
				...
				<div id="view3">
					...
					<fieldset class="hr">
						<label class="span2">Batasan Audit</label><br><br>
			...
			<center>
					...
					if($cek_posisi=='8918ca5378a1475cd0fa5491b8dcf3d70c0caba7'){ //katim
						if ($arr_lha ['lha_status'] == '0' || $arr_lha ['lha_status'] == '5') {
							...
							echo "&nbsp;&nbsp;&nbsp;<input type=\"submit\" class=\"blue_btn\" value=\"Tolak Pengajuan\" onclick=\"document.getElementById('status_lha').value=5\">";
							...
							echo "&nbsp;&nbsp;&nbsp;<input type=\"submit\" class=\"blue_btn\" value=\"Tolak Pengajuan\" onclick=\"document.getElementById('status_lha').value=6\">";
							echo "&nbsp;&nbsp;&nbsp;<input type=\"submit\" class=\"blue_btn\" value=\"Setujui\" onclick=\"document.getElementById('status_lha').value=3\">";
						} else if ($arr_lha ['lha_status'] == '3') {
