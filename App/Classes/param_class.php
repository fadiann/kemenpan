...
class param {
	...
	function propinsi_data_viewlist($id="") {
		$condition = "";
		if($id!="") $condition = " and propinsi_id = '".$id."' ";
		$sql = "select propinsi_id, propinsi_name FROM par_propinsi where 1=1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	function audit_type_view_grid($key_search, $val_search, $all_field, $offset, $num_row) {
		...
		$sql = "select audit_type_id, audit_type_name, audit_type_desc, case audit_type_opsi when '1' then 'Pengawasan Pemeriksaan' when '2' then 'Pengawasan Non Pemeriksaan' when '3' then 'Lain lain' else '-' end as opsi 
	...
	function audit_type_data_viewlist($id="") {
		$condition = "";
		if($id!="") $condition = " and audit_type_id = '".$id."' ";
		$sql = "select audit_type_id, audit_type_name, audit_type_desc, audit_type_opsi FROM par_audit_type where audit_type_del_st = 1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function audit_type_add($name, $desc, $opsi) {
		$sql = "insert into par_audit_type (audit_type_id, audit_type_name, audit_type_desc, audit_type_opsi, audit_type_del_st) values ('".$this->uniq_id ()."', '".$name."', '".$desc."', '".$opsi."', '1')";
		$aksinyo = "Menambah Parameter Tipe Audit ".$name;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function audit_type_edit($id, $nama, $desc, $opsi) {
		$sql = "update par_audit_type set audit_type_name = '".$nama."', audit_type_desc = '".$desc."', audit_type_opsi = '".$opsi."' where audit_type_id = '".$id."' ";
	...
	function update_audit_type_del($id, $nama, $desc, $opsi) {
		$sql = "update par_audit_type set audit_type_del_st = '1', audit_type_name = '".$nama."', audit_type_desc = '".$desc."', audit_type_opsi = '".$opsi."' where audit_type_id = '".$id."' ";
	...
	// Sub Tipe Audit
	function sub_audit_type_count($key_search, $val_search, $all_field) {
		$condition = "";
		if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
		else {
			for($i=0;$i<count($all_field);$i++){
		...
		$sql = "select count(*) FROM par_sub_audit_type 
				join par_audit_type on sub_audit_type_id_type = audit_type_id
				where sub_audit_type_del_st = 1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		$arr = $data->FetchRow ();
		return $arr [0];
	}
	function sub_audit_type_view_grid($key_search, $val_search, $all_field, $offset, $num_row) {
		$condition = "";
		if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
		else {
			for($i=0;$i<count($all_field);$i++){
		...
		$sql = "select sub_audit_type_id, sub_audit_type_name, sub_audit_type_desc, audit_type_name
				FROM par_sub_audit_type 
				join par_audit_type on sub_audit_type_id_type = audit_type_id
				where sub_audit_type_del_st = 1 ".$condition." order by audit_type_name LIMIT $offset, $num_row";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function cek_nama_sub_audit_type($nama, $id = "") {
		$condition = "";
		if ($id != "")
			$condition = "and sub_audit_type_id != '".$id."' ";
		$sql = "select sub_audit_type_id, sub_audit_type_del_st FROM par_sub_audit_type where LCASE(sub_audit_type_name) = '".strtolower ( $nama )."' ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function sub_audit_type_data_viewlist($id) {
		$sql = "select sub_audit_type_id, sub_audit_type_id_type, sub_audit_type_name, sub_audit_type_desc FROM par_sub_audit_type where sub_audit_type_id = '".$id."' ";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function sub_audit_type_add($name, $desc, $type) {
		$sql = "insert into par_sub_audit_type (sub_audit_type_id, sub_audit_type_name, sub_audit_type_desc, sub_audit_type_id_type, sub_audit_type_del_st) values ('".$this->uniq_id ()."', '".$name."', '".$desc."', '".$type."', '1')";
		$aksinyo = "Menambah Parameter Sub Tipe Audit ".$name;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function sub_audit_type_edit($id, $nama, $desc, $type) {
		$sql = "update par_sub_audit_type set sub_audit_type_name = '".$nama."', sub_audit_type_desc = '".$desc."', sub_audit_type_id_type = '".$type."' where sub_audit_type_id = '".$id."' ";
		$aksinyo = "Mengubah Parameter Tipe Sub Audit dengan ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function sub_audit_type_delete($id) {
		$sql = "update par_sub_audit_type set sub_audit_type_del_st = '0' where sub_audit_type_id = '".$id."' ";
		$aksinyo = "Menghapus Parameter Sub Tipe Audit ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function update_sub_audit_type_del($id, $nama, $desc, $type) {
		$sql = "update par_sub_audit_type set sub_audit_type_del_st = '1', sub_audit_type_name = '".$nama."', sub_audit_type_desc = '".$desc."', sub_audit_type_id_type = '".$type."' where sub_audit_type_id = '".$id."' ";
		$aksinyo = "Menampilkan Kembali Parameter Sub Tipe Audit ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function sub_audit_type_list_by_tipe($id_tipe) {
		$sql = "select sub_audit_type_id, sub_audit_type_name
				FROM par_sub_audit_type 
				where sub_audit_type_id_type = '".$id_tipe."' and sub_audit_type_del_st = 1 order by sub_audit_type_name"; 
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	// end Sub Tipe Audit
	...
	function finding_type_data_viewlist($id = "") {
		$condition = "";
		if ($id != "") $condition = "and finding_type_id = '".$id."' ";
		$sql = "select finding_type_id, finding_type_code, finding_type_name, finding_type_del_st FROM par_finding_type where finding_type_del_st = 1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	// ref prgram
	function ref_program_count($key_search, $val_search, $all_field) {
		$condition = "";
		if($val_search!=""){
			if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
			else {
		...
		$sql = "select count(*) 
				FROM ref_program_audit
				left join par_aspek on ref_program_aspek_id = aspek_id
				where ref_program_del_st = 1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		$arr = $data->FetchRow ();
		return $arr [0];
	}
	function ref_program_view_grid($key_search, $val_search, $all_field, $offset, $num_row) {
		$condition = "";
		if($val_search!=""){
			if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
			else {
		...
		$sql = "select ref_program_id, ref_program_code, aspek_name, ref_program_title
				FROM ref_program_audit 
				left join par_aspek on ref_program_aspek_id = aspek_id
				where ref_program_del_st = '1'  ".$condition." LIMIT $offset, $num_row ";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	function ref_program_data_viewlist($id = "") {
		...
		if ($id != "")
			$condition = "and ref_program_id = '".$id."' ";
		$sql = "select ref_program_id, ref_program_id_type, ref_program_code, ref_program_aspek_id, ref_program_title, ref_program_procedure, aspek_name, concat(ref_program_code, ' - ' ,ref_program_title) as kode_judul, audit_type_name, ref_program_del_st
				FROM ref_program_audit
				left join par_audit_type on ref_program_id_type = audit_type_id
				left join par_aspek on ref_program_aspek_id = aspek_id
				where ref_program_del_st = 1 ".$condition; //echo $sql;
	...
	function ref_program_add($tipe_audit, $code, $aspek_id, $title, $procedure) {
		$sql = "insert into ref_program_audit (ref_program_id, ref_program_id_type, ref_program_code, ref_program_aspek_id, ref_program_title, ref_program_procedure, ref_program_del_st) 
				values
				('".$this->uniq_id ()."','".$tipe_audit."','".$code."','".$aspek_id."','".$title."','".$procedure."','1')";
		$aksinyo = "Menambah Referensi Program Audit ".$code;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function ref_program_edit($id, $tipe_audit, $code, $aspek_id, $title, $procedure) {
		$sql = "update ref_program_audit set ref_program_id_type = '".$tipe_audit."', ref_program_code = '".$code."', ref_program_aspek_id = '".$aspek_id."', ref_program_title = '".$title."', ref_program_procedure = '".$procedure."' 
	...
	function update_ref_program_del($id, $tipe_audit, $code, $aspek_id, $title, $procedure) {
		$sql = "update ref_program_audit set ref_program_del_st = '1', ref_program_id_type = '".$tipe_audit."', ref_program_code = '".$code."', ref_program_aspek_id = '".$aspek_id."', ref_program_title = '".$title."', ref_program_procedure = '".$procedure."' where ref_program_id = '".$id."' ";
	...
	// ref audit
	function ref_audit_count($key_search, $val_search, $all_field) {
		$condition = "";
		if($val_search!=""){
			if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
			else {
		...
		$sql = "select count(*) from ref_audit 
	...
	function ref_audit_view_grid ($key_search, $val_search, $all_field, $offset, $num_row ){
		$condition = "";
		if($val_search!=""){
			if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
			else {
		...
		$sql = "select ref_audit_id, ref_audit_nama, ref_audit_desc, kategori_ref_name, ref_audit_attach, ref_audit_link
				from ref_audit 
				left join par_kategori_ref on ref_audit_id_kategori = kategori_ref_id
				where ref_audit_del_st = 1 ".$condition." LIMIT $offset, $num_row";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	function ref_audit_data_viewlist($id = "") {
		...
		if ($id != "")
			$condition = "and ref_audit_id = '".$id."' ";
		$sql = "select ref_audit_id, ref_audit_nama, ref_audit_desc, ref_audit_id_kategori, ref_audit_attach, ref_audit_link, ref_audit_del_st, kategori_ref_name
				FROM ref_audit
				left join par_kategori_ref on ref_audit_id_kategori = kategori_ref_id
				where ref_audit_del_st = 1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
	...
	function ref_audit_add($id_kat, $name, $desc, $attach, $linksumber) {
		$sql = "insert into ref_audit (ref_audit_id, ref_audit_id_kategori, ref_audit_nama, ref_audit_desc, ref_audit_attach, ref_audit_link, ref_audit_del_st) 
				values
				('".$this->uniq_id ()."','".$id_kat."','".$name."','".$desc."','".$attach."','".$linksumber."','1')";
		$aksinyo = "Menambah Referensi Audit ".$name;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function ref_audit_edit($id, $id_kat, $name, $desc, $attach, $linksumber) {
		$sql = "update ref_audit set ref_audit_id_kategori = '".$id_kat."', ref_audit_nama = '".$name."', ref_audit_desc = '".$desc."', ref_audit_attach = '".$attach."', ref_audit_link = '".$linksumber."'
	...
	function update_ref_audit_del($id, $id_kat, $name, $desc, $linksumber) {
		$sql = "update ref_audit set ref_audit_del_st = '1', ref_audit_id_kategori = '".$id_kat."', ref_audit_nama = '".$name."', ref_audit_desc = '".$desc."', ref_audit_link = '".$linksumber."'  where ref_audit_id = '".$id."' ";
	...
	function sbu_add($kode, $nama, $sort, $status) {
		...
		$aksinyo = "Menambah Parameter SBU ".$kode;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function sbu_edit($id, $kode, $nama, $sort, $status) {
		...
		$aksinyo = "Mengubah Parameter SBU dengan ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function sbu_delete($id) {
		$sql = "update par_sbu set sbu_del_st = '0' where sbu_id = '".$id."' ";
		$aksinyo = "Menghapus Parameter SBU ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function update_sbu_del($id, $nama, $sort, $status) {
		...
		$aksinyo = "Menampilkan Kembali Parameter SBU ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	// end SBU
	...
	function sbu_rinci_add($prov, $sbu, $gol, $amount) {
		...
		$aksinyo = "Menambah Parameter SBU Rinci ".$prov."-".$sbu."-".$gol;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function sbu_rinci_edit($id, $prov, $sbu, $gol, $amount) {
		...
		$aksinyo = "Mengubah Parameter SBU Rinci dengan ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function sbu_rinci_delete($id) {
		$sql = "update par_sbu_rinci set sbu_rinci_del_st = '0' where sbu_rinci_id = '".$id."' ";
		$aksinyo = "Menghapus Parameter SBU Rinci dengan ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function update_sbu_rinci_del($id, $amount) {
		...
		$aksinyo = "Menampilkan Kembali Parameter SBU Rinci dengan ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function get_sbu_rinci($id, $golongan) {
		$sql = "select DISTINCT sbu_rinci_id, sbu_kode, sbu_rinci_amount, sbu_status, sbu_name
				from par_sbu_rinci 
				left join par_sbu on sbu_rinci_sbu_id = sbu_id
	...
	function kabupaten_view_grid($key_search, $val_search, $all_field, $offset, $num_row) {
		...
		$sql = "select kabupaten_id, kabupaten_name, propinsi_name
				FROM par_kabupaten
				left join par_propinsi on kabupaten_id_prov = propinsi_id
	...
	function kabupaten_data_viewlist($id) {
		$sql = "select kabupaten_id, kabupaten_id_prov, kabupaten_name FROM par_kabupaten where kabupaten_id = '".$id."' ";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	function kabupaten_edit($id, $propinsi_id, $nama) {
		$sql = "update par_kabupaten set kabupaten_id_prov = '".$propinsi_id."', kabupaten_name = '".$nama."' where kabupaten_id = '".$id."' ";
	...
	function sub_kel_data_viewlist($id="") {
		$condition = "";
		if ($id != "") $condition = "and sub_type_id != '".$id."' ";
		$sql = "select sub_type_id, sub_type_id_type, sub_type_code, sub_type_name, sub_type_del_st FROM par_finding_sub_type where 1 = 1 ". $condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	function jenis_temuan_data_viewlist($id="") {
		$condition = "";
		if ($id != "") $condition = " and jenis_temuan_id = '".$id."' ";
		$sql = "select jenis_temuan_id, jenis_temuan_id_sub_type, jenis_temuan_code, jenis_temuan_name, jenis_temuan_del_st FROM par_finding_jenis where 1=1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	function kode_rek_data_viewlist($id="") {
		$condition = "";
		if ($id != "") $condition = " and kode_rek_id = '".$id."' ";
		$sql = "select kode_rek_id, kode_rek_code, kode_rek_desc, kode_rek_del_st FROM par_kode_rekomendasi where 1=1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	...
	function bidang_sub_count($key_search, $val_search, $all_field) {
		...
		$sql = "select count(*) FROM par_aspek where aspek_del_st = 1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		$arr = $data->FetchRow ();
		return $arr [0];
	}
	function bidang_sub_view_grid($key_search, $val_search, $all_field, $offset, $num_row) {
		...
		$sql = "select aspek_id, aspek_name
				FROM par_aspek where aspek_del_st = 1 ".$condition." LIMIT $offset, $num_row";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function cek_nama_bidang_sub($nama, $id = "") {
		$condition = "";
		if ($id != "")
			$condition = "and aspek_id != '".$id."' ";
		$sql = "select aspek_id, aspek_del_st FROM par_aspek where LCASE(aspek_name) = '".strtolower ( $nama )."' ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function bidang_sub_data_viewlist($id) {
		$sql = "select aspek_id, aspek_name FROM par_aspek where aspek_id = '".$id."' ";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function bidang_sub_add($name) {
		$sql = "insert into par_aspek (aspek_id, aspek_name, aspek_del_st) values ('".$this->uniq_id ()."','".$name."','1')";
		$aksinyo = "Menambah Parameter Bidang Subtansi ".$name;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function bidang_sub_edit($id, $nama) {
		$sql = "update par_aspek set aspek_name = '".$nama."' where aspek_id = '".$id."' ";
		$aksinyo = "Mengubah Parameter Bidang Subtansi dengan ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function bidang_sub_delete($id) {
		$sql = "update par_aspek set aspek_del_st = '0' where aspek_id = '".$id."' ";
		$aksinyo = "Menghapus Parameter Bidang Subtansi ID ".$id;
		$this->_db->_dbexecquery ( $sql, $this->userId, $aksinyo );
	}
	function update_bidang_sub_del($id, $nama) {
		$sql = "update par_aspek set aspek_del_st = '1', aspek_name = '".$nama."' where aspek_id = '".$id."' ";
	...
	// end Ref Kategori
	//gambar
	function gambar_count($key_search, $val_search, $all_field) {
		$condition = "";
		if($val_search!=""){
			if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
			else {
		...
		$sql = "select count(*) from par_gambar 
				where 1=1 ".$condition;
		$data = $this->_db->_dbquery ( $sql );
		$arr = $data->FetchRow ();
		return $arr [0];
	}
	function gambar_view_grid($key_search, $val_search, $all_field, $offset, $num_row) {
		$condition = "";
		if($val_search!=""){
			if($key_search!="") $condition = " and ".$key_search." like '%".$val_search."%' ";
			else {
		...
		$sql = "select gambar_id, gambar_name, gambar_sort
				FROM par_gambar where 1=1 ".$condition." order by gambar_sort, gambar_name asc LIMIT $offset, $num_row";
		$data = $this->_db->_dbquery ( $sql );
		return $data;
	}
	function insert_gambar($gambar_name, $gambar_sort)
    {
        $sql = "insert into par_gambar
				(gambar_id, gambar_name, gambar_sort)
				values
				('" . $this->uniq_id() . "', '" . $gambar_name . "', '" . $gambar_sort . "')";
        $this->_db->_dbquery($sql);
    }
    function list_gambar()
    {
    	$sql = "select gambar_id, gambar_name
				FROM par_gambar order by gambar_sort asc";
		$data = $this->_db->_dbquery($sql);
		return $data;
    }

    function gambar_viewlist($id)
    {
        $sql = "SELECT gambar_name FROM par_gambar WHERE gambar_id = '".$id."'";
        $data = $this->_db->_dbquery($sql);
        $arr  = $data->FetchRow();
        return $arr[0];
    }

    function delete_gambar ($id, $gambar_name){
		$sql = "delete from par_gambar where gambar_id = '".$id."' and gambar_name = '" . $gambar_name . "' ";
		$this->_db->_dbquery ( $sql );
	}

	//par email

	function mail_data_list()
	{
		$sql = "select * from par_mail";
	...
	function save_mail_data($key, $value)
	{
