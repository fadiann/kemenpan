...
try {		
	...
	$rs_get_data = $param->sub_kel_data_viewlist();
	$count_data = $rs_get_data->RecordCount();
	if($count_data!=0){
		while($arr_get_data = $rs_get_data->FetchRow()){
			$content[] = array(
						"sub_type_id" => $arr_get_data['sub_type_id'],
						"sub_type_id_type" => $arr_get_data['sub_type_id_type'],
						"sub_type_code" => $arr_get_data['sub_type_code'],
						"sub_type_name" => $arr_get_data['sub_type_name'],
						"sub_type_del_st" => $arr_get_data['sub_type_del_st']
					);
		}
