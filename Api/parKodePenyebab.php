...
try {		
	...
	$rs_get_data = $param->kode_penyebab_data_viewlist();
	$count_data = $rs_get_data->RecordCount();
	if($count_data!=0){
		while($arr_get_data = $rs_get_data->FetchRow()){
			$content[] = array(
						"kode_penyebab_id" => $arr_get_data['kode_penyebab_id'],
						"kode_penyebab_name" => $arr_get_data['kode_penyebab_name'],
						"kode_penyebab_desc" => $arr_get_data['kode_penyebab_desc'],
						"kode_penyebab_del_st" => $arr_get_data['kode_penyebab_del_st']
					);
		}
